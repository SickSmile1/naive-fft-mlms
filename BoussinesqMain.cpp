...
int main() {
  ...
  matrix res({100, 9});
  int ct = 0;
  for (int i = 64; i < 4000; i+=64) {
    matrix res_t2 = BoussinesqMlms(2., i, 5);
    matrix res_t3 = BoussinesqMlms(2., i, 6);
    matrix res_t4 = BoussinesqMlms(2., i, 7);
