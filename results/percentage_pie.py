###
# adapted from https://matplotlib.org/stable/gallery/misc/svg_filter_pie.html#sphx-glr-gallery-misc-svg-filter-pie-py
###
import io
...
labels = '1st correction', 'naive calculation', 'calculate coarse stresses', 'interpolate grid', '2nd correction'
fracs = [12.96, 11.52, 2.35, 11.34, 61.4]
...
# save
#f = io.BytesIO()
plt.savefig("pie_plot.pdf", format="pdf")
