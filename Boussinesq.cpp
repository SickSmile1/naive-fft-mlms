...
// __________________________________________________________________
void transformToReam(cMatrix& Umn_tild, matrix& Umn, int Nx, int Ny) {
  fftw_plan p3;
  p3 = fftw_plan_dft_c2r_2d(Nx*2, Ny*2,
